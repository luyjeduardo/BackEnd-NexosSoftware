...
{
    public partial class MigrationNexosSoftware : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nombrescompletos = table.Column<string>(type: "varchar(50)", nullable: false),
                    Fechadenacimiento = table.Column<DateTime>(type: "date", nullable: false),
                    Ciudaddeprocedencia = table.Column<string>(type: "varchar(35)", nullable: false),
